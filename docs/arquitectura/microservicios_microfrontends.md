...
| maintenance-service | ordenes correctivas, asignaciones, tiempos y solicitudes de refacciones | Eventos diferidos hasta definir outbox | Validacion sincronica de RH; bloqueo/liberacion en Production; reserva/consumo en Inventory |
