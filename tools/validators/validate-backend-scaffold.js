...
const requiredPaths = [
  ...
  "backend/services/purchasing-service/app/main.py",
  "backend/services/purchasing-service/app/api.py",
  "backend/services/purchasing-service/app/authorization.py",
  "backend/services/purchasing-service/app/authorities.py",
  "backend/services/purchasing-service/app/repositories.py",
  "backend/services/purchasing-service/app/schemas.py",
  "backend/services/maintenance-service/app/main.py",
  "backend/services/maintenance-service/app/api.py",
  "backend/services/maintenance-service/app/authorization.py",
  "backend/services/maintenance-service/app/authorities.py",
  "backend/services/maintenance-service/app/repositories.py",
  "backend/services/maintenance-service/app/schemas.py",
  "backend/services/maintenance-service/tests/test_maintenance_api.py",
  "backend/services/maintenance_service_adapter.py",
