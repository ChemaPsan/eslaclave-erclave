...
MVP_MODULE_SEEDS: tuple[ModuleSeed, ...] = (
    ...
    ModuleSeed(
        code="purchasing",
        name="Compras",
        description="Proveedores, requisiciones, ordenes de compra, recepciones y abastecimiento.",
        status="active",
        owner_service="purchasing-service",
        public_feature=True,
        implementation_status="implemented",
        sort_order=45,
    ...
    ModuleSeed(
        code="maintenance",
        name="Mantenimiento",
        description="Ordenes correctivas, asignacion de tecnicos, tiempos, refacciones y continuidad operativa.",
        status="active",
        owner_service="maintenance-service",
        public_feature=True,
        implementation_status="implemented",
        sort_order=47,
        dependencies=("hr", "inventory"),
    ),
    ModuleSeed(
        code="billing",
        name="Billing",
