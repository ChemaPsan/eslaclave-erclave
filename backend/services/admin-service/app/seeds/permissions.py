...
RESOURCE_LABELS = {
    ...
    "service_order": ("ordenes de servicio", "service orders"), "service_order.time": ("tiempos de ordenes de servicio", "service-order time entries"),
    "service_order.cost": ("costos de ordenes de servicio", "service-order costs"), "service_order.evidence": ("evidencias de ordenes de servicio", "service-order evidence"),
...
ACTION_LABELS = {
    ...
    "cancel": ("Cancelar", "Cancel"), "transition": ("Cambiar estado de", "Transition"), "resolve": ("Resolver", "Resolve"), "close": ("Cerrar", "Close"), "assign": ("Asignar", "Assign"), "accept": ("Aceptar", "Accept"), "wait": ("Poner en espera", "Put on hold"), "submit_acceptance": ("Enviar a aceptacion", "Submit for acceptance"), "suspend": ("Suspender", "Suspend"), "reactivate": ("Reactivar", "Reactivate"),
